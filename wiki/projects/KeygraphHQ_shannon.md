...
- 最近上榜：2026-03-06
- 上榜次数：2
- 领域分类：security, cybersecurity, ai
- 语言：TypeScript
- GitHub Stars: 42686（最后更新：2026-05-17）
...
**分析**: 🔥 KeygraphHQ/shannon：白盒AI渗透测试工具，通过源码分析自动执行真实攻击验证Web/API漏洞
📈 今日增长迅速，值得关注
⭐ 明星项目，在开发者社区具有重要影响力
...
### 2026-05-17（日报收录）
**来源**: [日报 2026-05-17](../../daily/github-ai-trending-2026-05-17.html)
**分析**: 🔥 KeygraphHQ/shannon: 开源AI渗透测试工具，自动分析代码识别攻击向量并执行真实漏洞利用
📈 今日增长迅速，值得关注
⭐ 明星项目，在开发者社区具有重要影响力
🤖 AI Agent 领域持续火热，多智能体协作成为趋势
👥 社区活跃度：高 - 社区活跃，持续有开发者关注和贡献
...
| 项目 | 关联类型 | 说明 |
|------|----------|------|
| Ed1s0nZ/CyberStrikeAI | 同领域 | AI 渗透测试 · 安全领域 |
| aquasecurity/trivy | 同领域 | 安全扫描 · 容器/云安全 |
